...
class CallTreeNodeQueueChunkBuffer {
  // data structure to allow the creation of PreparedCallTreeNodeChunk by worker threads, so the main thread registering
  // the data accesses does not lose this time
public:
